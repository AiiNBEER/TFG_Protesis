...
# Definir el rango de tiempo de 30 segundos
start_time = data['Timestamp'].min()
end_time = start_time + pd.Timedelta(seconds=30)

# Filtrar los datos para el rango de tiempo de 30 segundos
...
ax.set_title('Señales EMG con cambios de color según el gesto (30 segundos)')
plt.tight_layout()
